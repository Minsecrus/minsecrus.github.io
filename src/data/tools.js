export const data = [
    ...
    { name: "Spec Kit", category: "开发工具", description: "GitHub 开源的规格驱动开发工具包，为 AI 编程流程生成规范、计划和任务", link: "https://github.com/github/spec-kit" },
    ...
    { name: "OpenClaw", category: "AI 助手", description: "可自托管和扩展的开源个人 AI Agent", link: "https://github.com/openclaw/openclaw" },
    ...
    { name: "uv", category: "DevOps", description: "使用 Rust 编写的高速 Python 包与项目管理器", link: "https://docs.astral.sh/uv/" },
    ...
    { name: "Google Antigravity", category: "AI 助手", description: "Google 推出的智能体优先开发平台，支持多代理编排", link: "https://antigravity.google/" },
    { name: "AFFiNE", category: "生产力与组织", description: "开源、本地优先的文档、白板和知识库一体化工作区", link: "https://affine.pro/" },
    { name: "Hermes Agent", category: "AI 助手", description: "可自托管和扩展的开源个人 AI Agent", link: "https://github.com/NousResearch/hermes-agent" },
    { name: "Vue", category: "前端开发", description: "广泛使用的渐进式 JavaScript 框架", link: "https://vuejs.org/" },
    { name: "Ghostty", category: "开发工具", description: "面向 macOS 和 Linux 的原生 GPU 加速终端模拟器", link: "https://ghostty.org/" },
    { name: "Java", category: "编程语言", description: "广泛应用的面向对象编程语言", link: "https://www.java.com/" },
    { name: "Penpot", category: "设计与制作", description: "面向产品团队的开源 UI 设计、原型与协作平台", link: "https://penpot.app/" },
    { name: "Ruff", category: "DevOps", description: "使用 Rust 编写的高速 Python 代码检查与格式化工具", link: "https://docs.astral.sh/ruff/" },
    { name: "Notion", category: "生产力与组织", description: "一体化工作空间，笔记、数据库、看板等", link: "https://www.notion.so/" },
    { name: "Bevy", category: "游戏开发", description: "使用 Rust 构建、采用数据驱动 ECS 架构的开源游戏引擎", link: "https://bevy.org/" },
    { name: "DuckDB", category: "数据库", description: "面向本地分析工作负载的嵌入式列式 SQL 数据库", link: "https://duckdb.org/" },
    { name: "Zen Browser", category: "系统工具", description: "基于 Firefox、注重隐私与专注体验的开源浏览器", link: "https://zen-browser.app/" },
    { name: "Go", category: "编程语言", description: "Google 开发的静态类型编译语言", link: "https://golang.org/" },
    { name: "Trivy", category: "系统与安全", description: "扫描容器、代码仓库、Kubernetes 和云配置漏洞的开源工具", link: "https://trivy.dev/" },
    { name: "Polars", category: "数据处理", description: "使用 Rust 编写的高性能 DataFrame 与查询引擎", link: "https://pola.rs/" },
    { name: "IntelliJ IDEA", category: "开发工具", description: "JetBrains 出品的 Java 集成开发环境", link: "https://www.jetbrains.com/idea/" },
    { name: "n8n", category: "AI 助手", description: "连接应用与服务的可视化工作流自动化平台", link: "https://github.com/n8n-io/n8n" },
    { name: "SGLang", category: "机器学习", description: "面向大语言和多模态模型的高性能推理与服务框架", link: "https://docs.sglang.io/" },
    { name: "Better Auth", category: "后端开发", description: "框架无关、支持插件扩展的 TypeScript 身份验证框架", link: "https://better-auth.com/" },
    { name: "SQL", category: "编程语言", description: "用于管理关系数据库的查询语言", link: "https://en.wikipedia.org/wiki/SQL" },
    { name: "Jujutsu", category: "DevOps", description: "兼容 Git、支持操作日志与自动变基的现代版本控制系统", link: "https://docs.jj-vcs.dev/latest/" },
    { name: "Raycast", category: "生产力与组织", description: "可扩展的快捷启动、搜索和自动化工具，Windows 版处于公开测试", link: "https://www.raycast.com/" },
    { name: "SigNoz", category: "DevOps", description: "基于 OpenTelemetry 的开源日志、指标与分布式追踪平台", link: "https://signoz.io/" },
    { name: "C#", category: "编程语言", description: "微软开发的面向对象编程语言", link: "https://docs.microsoft.com/en-us/dotnet/csharp/" },
    { name: "Hono", category: "后端开发", description: "基于 Web 标准、可运行于多种 JavaScript 运行时的轻量 Web 框架", link: "https://hono.dev/" },
    { name: "AutoGPT", category: "AI 助手", description: "用于构建、运行和管理自主 AI Agent 的开源平台", link: "https://github.com/Significant-Gravitas/AutoGPT" },
    { name: "Biome", category: "DevOps", description: "集格式化、代码检查和辅助迁移于一体的 Web 工具链", link: "https://biomejs.dev/" },
    { name: "MySQL", category: "数据库", description: "最流行的开源关系型数据库", link: "https://www.mysql.com/" },
    { name: "OpenTofu", category: "DevOps", description: "Linux 基金会托管的开源基础设施即代码工具", link: "https://opentofu.org/" },
    { name: "marimo", category: "数据处理", description: "可复现、可版本控制并能部署为应用的响应式 Python 笔记本", link: "https://marimo.io/" },
    { name: "Stack Overflow", category: "资源库", description: "全球最大的程序员问答社区", link: "https://stackoverflow.com/" },
    { name: "Infisical", category: "系统与安全", description: "用于管理密钥、证书和基础设施访问的开源平台", link: "https://infisical.com/" },
    { name: "Oxlint", category: "DevOps", description: "使用 Rust 编写的高速 JavaScript 与 TypeScript 代码检查器", link: "https://oxc.rs/docs/guide/usage/linter.html" },
    { name: "JetBrains Air", category: "开发工具", description: "面向多 AI 编程代理并行委派与审查的开发环境（公开预览）", link: "https://air.dev/" },
    { name: "Gleam", category: "编程语言", description: "运行于 BEAM 和 JavaScript、强调类型安全的函数式编程语言", link: "https://gleam.run/" },
    { name: "TensorFlow", category: "机器学习", description: "开源的机器学习框架", link: "https://www.tensorflow.org/" },
    { name: "OpenCode", category: "AI 助手", description: "可理解代码库并执行开发任务的开源编程 Agent", link: "https://github.com/anomalyco/opencode" },
    { name: "Compose Multiplatform", category: "跨平台开发", description: "使用 Kotlin 和声明式 UI 共享 Android、iOS、桌面及 Web 界面的框架", link: "https://kotlinlang.org/compose-multiplatform/" },
    { name: "HTML", category: "前端开发", description: "网页内容的标准标记语言", link: "https://developer.mozilla.org/en-US/docs/Web/HTML" },
    { name: "Elysia", category: "后端开发", description: "面向 Bun、强调类型安全与性能的 TypeScript Web 框架", link: "https://elysiajs.com/" },
    { name: "ty", category: "开发工具", description: "Astral 推出的高速 Python 类型检查器与语言服务器", link: "https://docs.astral.sh/ty/" },
    { name: "Slack", category: "通讯与协作", description: "团队沟通与协作平台", link: "https://slack.com/" },
    { name: "PGlite", category: "数据库", description: "可在浏览器、Node.js 和 Bun 中运行的 WebAssembly PostgreSQL", link: "https://pglite.dev/" },
    { name: "Ollama", category: "机器学习", description: "在本地设备运行和管理 AI 模型的开源工具", link: "https://github.com/ollama/ollama" },
    { name: "OpenTelemetry", category: "DevOps", description: "用于生成、收集和导出日志、指标与链路数据的可观测性标准工具集", link: "https://opentelemetry.io/" },
    { name: "CSS", category: "前端开发", description: "用于描述网页样式的语言", link: "https://developer.mozilla.org/en-US/docs/Web/CSS" },
    { name: "Lynx", category: "跨平台开发", description: "使用 Web 技术构建原生移动端、桌面端和 Web 界面的跨平台框架", link: "https://lynxjs.org/" },
    { name: "TanStack Start", category: "全栈开发", description: "基于 TanStack Router 的类型安全 React 全栈框架（RC）", link: "https://tanstack.com/start/latest" },
    { name: "Qt", category: "跨平台开发", description: "跨平台应用程序开发框架", link: "https://www.qt.io/" },
    { name: "OpenBao", category: "系统与安全", description: "由 Linux 基金会 OpenSSF 托管的开源密钥与凭据管理器", link: "https://openbao.org/" },
    { name: "Gemini Notebook", category: "学习与知识", description: "原 NotebookLM，以用户资料为依据进行总结、问答和研究的 AI 工具", link: "https://notebooklm.google/" },
    { name: "Webpack", category: "DevOps", description: "现代 JavaScript 应用的静态模块打包工具", link: "https://webpack.js.org/" },
    { name: "zizmor", category: "系统与安全", description: "检测并修复 GitHub Actions 常见安全问题的静态分析工具", link: "https://docs.zizmor.sh/" },
    { name: "Django", category: "后端开发", description: "Python Web 框架", link: "https://www.djangoproject.com/" },
    { name: "MoonBit", category: "编程语言", description: "面向 WebAssembly 等多后端的通用编程语言与一体化工具链", link: "https://www.moonbitlang.com/" },
    { name: "Embassy", category: "嵌入式开发", description: "基于 Rust async 的安全、高效嵌入式应用框架", link: "https://embassy.dev/" },
    ...
    { name: "MarkItDown", category: "数据处理", description: "将多种文档转换为便于模型处理格式的开源工具", link: "https://github.com/microsoft/markitdown" },
    ...
    { name: "Stable Diffusion WebUI", category: "设计与制作", description: "开源 AI 图像生成与创作工作流", link: "https://github.com/AUTOMATIC1111/stable-diffusion-webui" },
    ...
    { name: "Langflow", category: "AI 助手", description: "可视化构建 AI Agent 与自动化工作流的平台", link: "https://github.com/langflow-ai/langflow" },
    ...
    { name: "Firecrawl", category: "资源库", description: "面向 AI 应用的网页抓取与结构化数据工具", link: "https://github.com/firecrawl/firecrawl" },
    ...
    { name: "Dify", category: "AI 助手", description: "可视化构建 AI Agent 与自动化工作流的平台", link: "https://github.com/langgenius/dify" },
    ...
    { name: "Open WebUI", category: "AI 助手", description: "可自托管的 AI Agent 与模型交互工作空间", link: "https://github.com/open-webui/open-webui" },
    ...
    { name: "Claude Code", category: "AI 助手", description: "可理解代码库并执行开发任务的开源编程 Agent", link: "https://github.com/anthropics/claude-code" },
    ...
    { name: "ComfyUI", category: "设计与制作", description: "基于节点编排的生成式 AI 创作工作流", link: "https://github.com/Comfy-Org/ComfyUI" },
    ...
    { name: "llama.cpp", category: "机器学习", description: "面向多种硬件的高效 AI 模型推理引擎", link: "https://github.com/ggml-org/llama.cpp" },
    ...
    { name: "cc-switch", category: "开发工具", description: "管理 AI 编程工具配置、模型与环境的开源工具", link: "https://github.com/farion1231/cc-switch" },
    ...
    { name: "Gemini CLI", category: "AI 助手", description: "可理解代码库并执行开发任务的开源编程 Agent", link: "https://github.com/google-gemini/gemini-cli" },
    ...
    { name: "Browser Use", category: "AI 助手", description: "让 AI Agent 操作和自动化浏览器任务的开源框架", link: "https://github.com/browser-use/browser-use" },
    ...
    { name: "OpenAI Codex", category: "AI 助手", description: "可理解代码库并执行开发任务的开源编程 Agent", link: "https://github.com/openai/codex" },
    ...
    { name: "MoneyPrinterTurbo", category: "设计与制作", description: "自动生成和编排短视频内容的开源工作流", link: "https://github.com/harry0703/MoneyPrinterTurbo" },
    ...
    { name: "Deep-Live-Cam", category: "设计与制作", description: "面向 AI 视频生成或编辑的开源工作流", link: "https://github.com/hacksider/Deep-Live-Cam" },
    ...
    { name: "claude-mem", category: "开发工具", description: "为 AI 编程工具提供可持久化上下文记忆", link: "https://github.com/thedotmack/claude-mem" },
    ...
    { name: "vLLM", category: "机器学习", description: "高吞吐的大语言模型推理与服务引擎", link: "https://github.com/vllm-project/vllm" },
    ...
    { name: "PaddleOCR", category: "数据处理", description: "开源光学字符识别与文档信息提取工具", link: "https://github.com/PaddlePaddle/PaddleOCR" },
    ...
    { name: "RAGFlow", category: "AI 助手", description: "结合文档解析、检索与生成的开源 RAG 平台", link: "https://github.com/infiniflow/ragflow" },
    ...
    { name: "Odysseus", category: "AI 助手", description: "可自托管的 AI Agent 与模型交互工作空间", link: "https://github.com/pewdiepie-archdaemon/odysseus" },
    ...
    { name: "OpenHands", category: "AI 助手", description: "可执行代码修改、测试和工程任务的开源 Agent", link: "https://github.com/OpenHands/OpenHands" },
    ...
    { name: "LobeHub", category: "AI 助手", description: "可自托管的 AI Agent 与模型交互工作空间", link: "https://github.com/lobehub/lobehub" },
    ...
    { name: "Open Design", category: "设计与制作", description: "面向界面与产品设计的 AI 工作流工具", link: "https://github.com/nexu-io/open-design" },
    ...
    { name: "DeerFlow", category: "AI 助手", description: "用于深度研究和多步骤 Agent 编排的开源平台", link: "https://github.com/bytedance/deer-flow" },
    ...
    { name: "MinerU", category: "数据处理", description: "面向文档解析、结构化提取与 AI 应用的数据工具", link: "https://github.com/opendatalab/MinerU" },
    ...
    { name: "LlamaFactory", category: "机器学习", description: "用于大语言模型微调和训练优化的开源工具", link: "https://github.com/hiyouga/LlamaFactory" },
    ...
    { name: "GPT Academic", category: "资源库", description: "辅助论文阅读、检索和学术研究的开源 AI 工具", link: "https://github.com/binary-husky/gpt_academic" },
    ...
    { name: "OpenBB", category: "财务管理", description: "面向金融研究与分析的开源数据平台", link: "https://github.com/OpenBB-finance/OpenBB" },
    ...
    { name: "RTK", category: "开发工具", description: "优化 AI 编程上下文与 Token 使用的开发工具", link: "https://github.com/rtk-ai/rtk" },
    ...
    { name: "Pi", category: "AI 助手", description: "可理解代码库并执行开发任务的开源编程 Agent", link: "https://github.com/earendil-works/pi" },
    ...
    { name: "Unsloth", category: "机器学习", description: "用于大语言模型微调和训练优化的开源工具", link: "https://github.com/unslothai/unsloth" },
    ...
    { name: "Cline", category: "AI 助手", description: "集成 IDE、可执行开发任务的开源编程 Agent", link: "https://github.com/cline/cline" },
    ...
    { name: "Open Interpreter", category: "AI 助手", description: "可在本地调用计算机和代码执行能力的开源 Agent", link: "https://github.com/openinterpreter/openinterpreter" },
    ...
    { name: "Ruflo", category: "AI 助手", description: "用于协调多个 AI Agent 的开源编排平台", link: "https://github.com/ruvnet/ruflo" },
    ...
    { name: "AnythingLLM", category: "AI 助手", description: "可自托管的 AI Agent 与模型交互工作空间", link: "https://github.com/Mintplex-Labs/anything-llm" },
    ...
    { name: "Docling", category: "数据处理", description: "面向文档解析、结构化提取与 AI 应用的数据工具", link: "https://github.com/docling-project/docling" },
    ...
    { name: "World Monitor", category: "资源库", description: "聚合和可视化全球事件信息的开源监测工具", link: "https://github.com/koala73/worldmonitor" },
    ...
    { name: "TrendRadar", category: "资源库", description: "聚合热点信息并追踪趋势的开源监测工具", link: "https://github.com/sansan0/TrendRadar" },
    ...
    { name: "OpenSpec", category: "开发工具", description: "以规范、计划和任务驱动 AI 编程的开发工具", link: "https://github.com/Fission-AI/OpenSpec" },
    ...
    { name: "CareerOps", category: "生产力与组织", description: "用于求职管理和职业流程自动化的开源工具", link: "https://github.com/santifer/career-ops" },
    ...
    { name: "GPT-SoVITS", category: "设计与制作", description: "用于语音生成、克隆或处理的开源 AI 工作流", link: "https://github.com/RVC-Boss/GPT-SoVITS" },
    ...
    { name: "Context7", category: "开发工具", description: "为 AI 编程工具提供最新开发文档上下文", link: "https://github.com/upstash/context7" },
    ...
    { name: "PrivateGPT", category: "AI 助手", description: "面向本地私有文档的自托管 AI 知识工作空间", link: "https://github.com/zylon-ai/private-gpt" },
    ...
    { name: "OpenManus", category: "AI 助手", description: "可执行多步骤通用任务的开源 AI Agent", link: "https://github.com/FoundationAgents/OpenManus" },
    ...
    { name: "Daily Stock Analysis", category: "财务管理", description: "自动化股票数据分析和报告生成的开源工具", link: "https://github.com/ZhuLinsen/daily_stock_analysis" },
    ...
    { name: "Agent Reach", category: "资源库", description: "扩展 AI Agent 信息检索与内容获取能力的工具", link: "https://github.com/Panniantong/Agent-Reach" },
    ...
    { name: "Flowise", category: "AI 助手", description: "可视化构建 AI Agent 与自动化工作流的平台", link: "https://github.com/FlowiseAI/Flowise" },
    ...
    { name: "LiteLLM", category: "机器学习", description: "统一调用、路由和观测多家模型 API 的开源网关", link: "https://github.com/BerriAI/litellm" },
    ...
    { name: "whisper.cpp", category: "设计与制作", description: "在本地运行的高效语音识别与转写工具", link: "https://github.com/ggml-org/whisper.cpp" },
    ...
    { name: "Goose", category: "AI 助手", description: "可理解代码库并执行开发任务的开源编程 Agent", link: "https://github.com/aaif-goose/goose" },
    ...
    { name: "Fooocus", category: "设计与制作", description: "开源 AI 图像生成与创作工作流", link: "https://github.com/lllyasviel/Fooocus" },
    ...
    { name: "LocalAI", category: "机器学习", description: "在本地设备运行和管理 AI 模型的开源工具", link: "https://github.com/mudler/LocalAI" },
    ...
    { name: "Text Generation WebUI", category: "机器学习", description: "用于本地加载、管理和交互大语言模型的 WebUI", link: "https://github.com/oobabooga/textgen" },
    ...
    { name: "Umi-OCR", category: "数据处理", description: "开源光学字符识别与文档信息提取工具", link: "https://github.com/hiroi-sora/Umi-OCR" },
    ...
    { name: "PPT Master", category: "设计与制作", description: "借助 AI 生成和编辑演示文稿的开源工具", link: "https://github.com/hugohe3/ppt-master" },
    ...
    { name: "OpenMontage", category: "设计与制作", description: "面向 AI 视频生成或编辑的开源工作流", link: "https://github.com/calesthio/OpenMontage" },
    ...
    { name: "NanoClaw", category: "AI 助手", description: "可自托管和扩展的开源个人 AI Agent", link: "https://github.com/nanocoai/nanoclaw" },
    ...
    { name: "PandasAI", category: "数据处理", description: "用自然语言分析数据与 DataFrame 的开源 AI 工具", link: "https://github.com/sinaptik-ai/pandas-ai" },
    ...
    { name: "Meetily", category: "生产力与组织", description: "本地优先的会议录音、转写与摘要工具", link: "https://github.com/Zackriya-Solutions/meetily" },
    ...
    { name: "Coze Studio", category: "AI 助手", description: "可视化构建 AI Agent 与自动化工作流的平台", link: "https://github.com/coze-dev/coze-studio" },
    ...
    { name: "Toonflow", category: "设计与制作", description: "用于生成和编排 AI 短剧内容的开源工作流", link: "https://github.com/HBAI-Ltd/Toonflow-app" },
]
