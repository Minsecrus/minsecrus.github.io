...
export function Toolbox() {
    ...
    const tools = [
        { name: "React", category: "前端开发", description: "用于构建用户界面的 JavaScript 库" },
        { name: "VS Code", category: "开发环境", description: "轻量级代码编辑器" },
        { name: "Node.js", category: "后端开发", description: "基于 Chrome V8 引擎的 JavaScript 运行环境" },
        ...
        { name: "Blender", category: "设计与创意", description: "3D 创作套件" },
        ...
        { name: "Chart.js", category: "前端开发", description: "简单 yet 灵活的图表库" },
        { name: "Helm", category: "DevOps 与部署", description: "Kubernetes 包管理器" },
        ...
        { name: "Cinema 4D", category: "设计与创意", description: "3D 动画软件" },
        ...
        { name: "Replit", category: "开发环境", description: "在线 IDE" },
        { name: "Ulysses", category: "写作与编辑", description: "Markdown 写作应用 (Apple 平台)" },
        { name: "esbuild", category: "构建与测试", description: "极速 JavaScript 打包器" },
        ...
        { name: "JUnit", category: "构建与测试", description: "Java 单元测试框架" },
